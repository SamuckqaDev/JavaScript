...
let context = canvas.getContext("2d"); //Renderizar como imagem '2d' dentro do canvas;
let box = 32;
let snake = []; //criar cobrinha como lista para adição e remoção dos valores;
...
//evento de click, para detecatar chamda das funções pelo botão;
...
function inicializeGame() {
    ...
    if (snakeX != food.x || snakeY != food.y) {
        snake.pop(); //remove último elemento da lista
    } else {
